...
class SkillBuilderCh3Pt1Tests {
    ...
    void testInsertionSort5() {
        ...
        // Now sort
        InsertionSortFromBookModified.insertionSort(ourHoldings);
        // Now reprint
    ...
    void testInsertionSort7() {
        ...
        System.out.println(portfolioString);
        // Next
        InsertionSortFromBookModified.insertionSort(ourHoldings, PortfolioHolding.symbolComparatorZtoA);
        portfolioString = PortfolioUtilities.buildDisplayString(ourHoldings, '\n');
    ...
    void testInsertionSort8() {
        String portfolioString = JavaUtilArraysExamples.skillBuilderPart8();
        String Answer1 = SB2AnswerMap.map.get("Answer1");
        //System.out.println("Answer1 is:\n" + Answer1);
        Assertions.assertEquals(Answer1, portfolioString);
    }
    ...
    // Part 9
    @Test
    void testInsertionSort9() {
        String portfolioString = JavaUtilArraysExamples.skillBuilderPart9();
        //String Answer2 = SB2AnswerMap.map.get("Answer2");
        //System.out.println("Answer2 is:\n" + Answer1);
        Assertions.assertEquals(Answer2, portfolioString);
    }
    ...
    // Part 10
    @Test
    void testInsertionSort10() {
        String returnString = JavaUtilArrayListExample.skillBuilderPart10();
        Assertions.assertEquals("[Helen, Janet, Jonas, Joseph, Rene, Virginia]", returnString);
    }
